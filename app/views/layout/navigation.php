    ...
    <div class="container">
        <div class="header-bar">
            <div class="brand">
                <a href="<?= BASE_URL ?>/index.php" class="brand-link">
                    <div class="brand-icon" aria-hidden="true">
                        <!--IMAGEN DEL LOGO-->
                        <img src="<?= BASE_URL ?>/img/logo.svg" alt="RunLabs">
                    </div>
                </a>
            </div>
            ...
            <div class="header-actions">
                <?php if ($logged): ?>
                    <?php if ($role === 'admin'): ?>
                        ...
                        <button class="btn btn-light btn-lg"
                            onclick="window.location.href='<?= BASE_URL ?>/admin.php'">
                        ...
                        <button class="btn btn-primary btn-lg"
                            onclick="window.location.href='<?= BASE_URL ?>/app/helpers/logout.php'">
                    ...
                    <?php if ($role === 'client'): ?>
                        ...
                        <!-- ORDER -->
                        <button class="btn btn-light btn-lg"
                            onclick="window.location.href='<?= BASE_URL ?>/orders.php'">
                        ...
                        <!-- CART -->
                        <button class="btn btn-light btn-lg"
                            onclick="window.location.href='<?= BASE_URL ?>/cart.php'">
                ...
                <?php else: ?>
                    <!-- USER -->
                    <button class="btn btn-primary btn-lg" onclick="window.location.href='<?= BASE_URL ?>/login.php'">
